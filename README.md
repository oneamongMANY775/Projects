...
## Nirbhik Navin | Embedded Systems & Firmware Portfolio
...
* Redesigned flight controller PCBs with TVS diodes and SD card logging for enhanced reliability.


* Implemented a dedicated **Power Distribution Board (PDB)** and gimbal control architecture.
...
* **Scope:**
* Developed custom libraries for **LTC6812** battery monitoring ICs.


* Designed noise-resistant PCBs utilizing differential **iso-SPI** and optimized trace lengths.


* Developed deterministic, interrupt-driven algorithms for ECU task execution.
