...
void cs_low(void)
{
    ...
    HAL_GPIO_WritePin(LTC6812_CHIP_SELECT_GPIO_PORT, LTC6812_CHIP_SELECT_GPIO_PIN, GPIO_PIN_RESET);
}

void cs_high(void)
{
    HAL_GPIO_WritePin(LTC6812_CHIP_SELECT_GPIO_PORT, LTC6812_CHIP_SELECT_GPIO_PIN, GPIO_PIN_SET);
}
